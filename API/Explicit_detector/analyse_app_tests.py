...
# Script to train to analyse the percentage of explicitness of an app
...
# Number of features to test the classifier. The number left is for training.
number_testing = 1000
...
def analyse_app_train(illust2vec, app_info):
	...
	training_set = featuresets[number_testing:]

	testing_set = featuresets[:number_testing]
	...
	try:
		print "\n****** NU SVC ************"
		saving_model=results(SklearnClassifier(NuSVC(nu=0.1)), testing_set, training_set)
	except:
		pass
	try:
		print "\n****** Extra Trees ************"
